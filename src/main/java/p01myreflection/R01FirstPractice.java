...
public class R01FirstPractice {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Class<?> engineType = Class.forName("p01vehicles.P01Car$Engine"); //내부정보에 접근하려면 달러$ 기호 사용
