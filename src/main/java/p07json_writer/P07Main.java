...
import p07data.P07Address;
import p07data.P07Company;
import p07data.P07Person;
...
//        P07Company company = new P07Company("STC", "Seoul", new P07Address("BongUnSa", (short) 600));
//        P07Address address = new P07Address("BongUnSa", (short) 1);
//        P07Person person = new P07Person("Kadun", true, 29, 100.555f, address, company);
//
//        String json = objectToJson(person, 0);
//
//        System.out.println(json);

        P07Actor actor1 = new P07Actor("Elijah Wood", new String[]{"Lord of the Rings", "The Good Son"});
        P07Actor actor2 = new P07Actor("Ian McKellen", new String[]{"X-Men", "Hobbit"});
        P07Actor actor3 = new P07Actor("Orlando Bloom", new String[]{"Pirates of the Caribbean", "Kingdom of Heaven"});
        P07Movie movie = new P07Movie("Lord of the Rings", 8.8f, new String[]{"Action", "Adventure", "Drama"},
                new P07Actor[]{actor1, actor2, actor3});
